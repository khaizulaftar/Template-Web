...
export default function Navbar() {
    ...
    return (
        <>
            <div className="flex lg:hidden fixed w-full z-50">
                <aside className="flex flex-col w-full shadow p-6 overflow-y-auto bg-white m-4 dark:bg-gray-900 dark:border-gray-700 rounded-2xl" style={{ scrollbarWidth: "none" }}>
                    ...
                    {Isopen ?
                        ...
                        <div className="flex flex-col mt-6 gap-3">
                            <nav className="flex flex-col gap-4">
                                {item1.map((v, i) => (
                                    <Link href={v.link} key={i} className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 focus:text-gray-700">
                                        {v.logo}
                            ...
                            <nav className="flex flex-col gap-2">
                                {item2.map((v, i) => (
                                    <a key={i} className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 focus:text-gray-700" href="#">
