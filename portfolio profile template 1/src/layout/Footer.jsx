                ...
                <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="text-left">
                                ...
                                <ul className="mt-8 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a className="text-gray-200 transition hover:text-gray-200/75" href="#"> Web Design </a>
                                    </li>

                                    <li>
                                        <a className="text-gray-200 transition hover:text-gray-200/75" href="#"> Marketing </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="mt-12 border-t border-gray-100 pt-6">
                        <div className="text-center sm:text-left">
                            <p className="mt-4 text-sm text-gray-200 sm:order-first sm:mt-0">&copy; 2022 Company Name</p>
                        </div>
                    </div>
                </div>
            </footer>
